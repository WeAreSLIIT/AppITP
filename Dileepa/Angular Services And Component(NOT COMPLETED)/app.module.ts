...
import { PurchasedGiftVoucherService } from './services/purchased-gift-voucher.service';
...
@NgModule({
  ...
  providers: [DiscountTypeService, DiscountScheduleService, PurchasedGiftVoucherService, AddGiftVoucherService ],
